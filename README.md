...
- **`config:PutEvaluations`** - This action does not support resource-level permissions (per AWS API design). The Lambda uses it to report compliance results back to the AWS Config custom rule.
